...
// ['BANANA', 'MANGO', 'APPLE']
// Этот процесс называется контекстная типизация (contextual typing), так как контекст определения функции позволяет вывести типы входных параметров. 
// В итоге код выглядит идентично коду на JavaScript.



// Если функция определяется вне контекста, то к ней применяются те же правила, что и к именованным функциям. 
// То есть типы параметров должны быть заданы во время определения:
